...
/* function to calculate the sum of two numbers */
void calculateSum(int* number1ptr, int* number2ptr, int* sumptr)
{
    *sumptr = *number1ptr + *number2ptr;
}
/* function to display details to the screen */
void displayDetails(void)
{
    printf("Author : Selija Gangani\n");
    printf("Stud ID : 110322708\n");
    printf("Email ID : gansy027@mymail.unisa.edu.au\n");
